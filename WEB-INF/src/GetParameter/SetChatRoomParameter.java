...
public class SetChatRoomParameter implements BaseGetParameter,BaseGetLoginoutParameter{
	...
	public ArrayList<AllInfo> register(HttpServletRequest req) {
		...
		//バリデーション
		ErrorMessage error = ChatRoomVaidation.validationRegisterChatRomm(allInfoList);
		if(!(error.isEmpty())){
