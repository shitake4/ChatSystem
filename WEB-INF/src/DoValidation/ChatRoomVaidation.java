...
public class ChatRoomVaidation {
  ...
  public static ErrorMessage validationRegisterChatRomm(
      ArrayList<AllInfo> allInfoList) {
    ErrorMessage error = new ErrorMessage();
    for (int i = 0; i < allInfoList.size(); i++) {
      if (allInfoList.get(i).getRoomName() == null
          || allInfoList.get(i).getRoomName().equals("")) {
