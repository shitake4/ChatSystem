...
public class UpdateDBManager extends BaseDBManager {
  ...
  private static Logger logger = LoggerFactory.getLogger(UpdateDBManager.class
      .getName());
  ...
  public static int insertAccount(String name, String mail, String pass,
      String prefecture, String tel, int age, String accountUrl)
      throws SQLException {
  ...
  public static int creatChatRoom(String roomName, List<Integer> chatMember,
      String roomPass) throws SQLException {
  ...
  private static int insertInitialChatRoomMember(int lastChatId,
      List<Integer> chatMember) throws SQLException {
    int sqlResult = 0;
  ...
  public int deprivationAuthority(int chatId, int accountId)
      throws SQLException {
    Connection conn = getConnection();
  ...
  public static int insertChatContent(int chatId, String content,
      int accountId, String filePath) throws SQLException {
    Connection conn = getConnection();
  ...
  public static int insertAdminConetentLeave(int chatId, String name)
      throws SQLException {
  ...
  public static void insertAdminContentJoin(int chatId, String name)
      throws SQLException {
  ...
  public static int changeAccountInfo(String mail, String pass,
      String prefecture, String tel, int age, int accountId, String accountUrl)
      throws SQLException {
    Connection conn = getConnection();
    String hashPass = Hash.encryptStr(pass);
  ...
  public static int changeAccountInfoNonPass(String mail, String prefecture,
      String tel, int age, int accountId, String accountUrl)
      throws SQLException {
    Connection conn = getConnection();
  ...
  public static int insertChatRoomMember(int chatId, int accountId)
      throws SQLException {
    Connection conn = getConnection();
    String sql = "insert into room_member(chat_id,account_id) values (?,?)";
    PreparedStatement pstmt = conn.prepareStatement(sql);
  ...
  public static int deleteChatRoomMember(int chatId, int accountId)
      throws SQLException {
    Connection conn = getConnection();
  ...
  public static int requestFriend(int accountId, int friendsAccountId)
      throws SQLException {
    Connection conn = getConnection();
  ...
  private static void deleteFriendsRequest(int accountId, int friendsAccountId)
      throws SQLException {
    Connection conn = getConnection();
  ...
  private static void deleteMyfriendsList(int accountId, int friendsAccountId)
      throws SQLException {
    Connection conn = getConnection();
  ...
  private static void deleteOtherfriendsList(int accountId, int friendsAccountId)
      throws SQLException {
    Connection conn = getConnection();
    String sql = "DELETE from friends_list WHERE account_id = ? AND friends_account_id = ?;";
    PreparedStatement pstmt = conn.prepareStatement(sql);
  ...
  private static void insertMyFriendList(int accountId, int friendsAccountId)
      throws SQLException {
    Connection conn = getConnection();
  ...
  private static void insertOtherFriendList(int accountId, int friendsAccountId)
      throws SQLException {
    Connection conn = getConnection();
    String sql = "INSERT INTO friends_list values(?,?)";
    PreparedStatement pstmt = conn.prepareStatement(sql);
