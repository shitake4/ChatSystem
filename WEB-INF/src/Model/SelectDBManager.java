...
public class SelectDBManager extends BaseDBManager{
	...
	public static ArrayList<AccountInfo> selectChatRoomMember(int chatId) throws SQLException{
		Connection conn = getConnection();
	...
	public static boolean checkOverlapAccout(String name,String pass) throws SQLException{
		Connection conn = getConnection();
	...
	public static ArrayList<ChatContents> selectChatContents (int chatId) throws SQLException{
		Connection conn = getConnection();
	...
	public static AccountInfo getLoginAccountInfo(String name, String pass) throws SQLException{
		Connection conn = getConnection();
		String hashPass = Hash.encryptStr(pass);
	...
	public static AllInfo selectAccountAllInfo(int accountId) throws SQLException{
		...
		while(rs.next()){
			...
			chatMember.setUrl(p.matcher(rs.getString("account_url")).replaceFirst(""));
		}
		rs.close();
		conn.close();
		return chatMember;
	...
	public static ArrayList<AccountInfo> getFriendsList (int accountId) throws SQLException{
		Connection conn = getConnection();
	...
	public static ArrayList<AccountInfo> getChatRoomFriendsList (int chatId,int accountId) throws SQLException{
		Connection conn = getConnection();
	...
	public static ArrayList<AccountInfo> getFriendsRequestList (int accountId) throws SQLException{
		Connection conn = getConnection();
	...
	public static ArrayList<AccountInfo> getSendingFriendsRequestList (int accountId) throws SQLException{
		Connection conn = getConnection();
	...
	public static ArrayList<JoinChatRoom> selectJoinRoom(int accountId) throws SQLException{
		Connection conn = getConnection();
	...
	public static boolean checkAbsenceChatRoomMember(int chatId) throws SQLException{
		Connection conn = getConnection();
	...
	public static boolean checkRoomMemberOrNot(int chatId,int accountId) throws SQLException{
		Connection conn = getConnection();
	...
	public AllInfo chechChatRoomAuthority(int chatId, int accountId) throws SQLException{
		Connection conn = getConnection();
