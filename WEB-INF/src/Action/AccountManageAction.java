...
public class AccountManageAction implements BaseAction{
	...
	public String moidfy(HttpServletRequest req, Object ob) {
		...
		if(pass == null || pass.equals("")){
			try {
				sqlResult = UpdateDBManager.changeAccountInfoNonPass(mail, prefecture, tel, age, accountId, accountUrl);
			...
			try {
				sqlResult = UpdateDBManager.changeAccountInfo(mail, pass, prefecture, tel, age, accountId, accountUrl);
			} catch (SQLException e) {
				e.printStackTrace();
			}
		}
