...
public class RoomMemberCheck implements Filter{
	...
	private static Logger logger = LoggerFactory.getLogger(RoomMemberCheck.class.getName());
	...
	public void doFilter(ServletRequest arg0, ServletResponse arg1,
		...
		if(!sqlResult){
			...
			((HttpServletResponse)arg1).sendRedirect(propaty.getString("chatListServlet"));
		}else{
